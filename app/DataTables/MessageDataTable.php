...
class MessageDataTable extends DataTable
{
    ...
    {
        return [
            'title' => new Column(['title' => __('models/messages.fields.title'), 'data' => 'title']),
            'message' => new Column(['title' => __('models/messages.fields.message'), 'data' => 'message']),
            'file' => new Column(['title' => __('models/messages.fields.file'), 'data' => 'file'])
        ];
    }

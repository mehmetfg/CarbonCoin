<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route("exchange.report")); ?>">
        <div class="card">
    <div class="row m-5">
                ...
                <div class="card o-hidden">
                    <div class="bg-danger b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body"><span class="m-0"> <?php echo e(local_price_format($tradeData->where("taker_side", "BID")->first()->totalAmount?? 0)); ?>   CYCE</span>
            ...
            <div class="card o-hidden">
                <div class="bg-primary b-r-4 card-body">
                    <div class="media static-top-widget">
                        ...
                        <div class="media-body"><span class="m-0"> <?php echo e(local_price_format($tradeData->where("taker_side", "ASK")->first()->totalAmount ?? 0)); ?> CYCE</span>
            ...
            <div class="card o-hidden">
                <div class="bg-secondary b-r-4 card-body">
                    <div class="media static-top-widget">
                        ...
                        <div class="media-body"><span class="m-0"><?php echo e(local_price_format($tradeData->sum("totalAmount"))); ?>   CYCE</span>
            ...
            <div class="card o-hidden">
                <div class="bg-secondary b-r-4 card-body">
                    <div class="media static-top-widget">
                        ...
                        <div class="media-body"><span class="m-0"> <?php echo e(local_price_format($tradeData->sum("totalFee"))); ?>  CYCE</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\CryptoCarbon\resources\views/report/exchange-report.blade.php ENDPATH**/ ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <?php endif; ?>
                    <a  class="ml-4 px-4 py-2 bg-blue-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-black-900 active:bg-gray-900 focus:outline-none focus:border-black-900 focus:ring focus:ring-gray-300" href="<?php echo e(route('register')); ?>">
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\CryptoCarbon\resources\views/auth/login.blade.php ENDPATH**/ ?>
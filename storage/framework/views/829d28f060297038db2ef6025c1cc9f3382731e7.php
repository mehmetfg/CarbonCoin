                    ...
                    <li class="profile-nav onhover-dropdown p-0 me-0">
                        ...
                        <ul class="profile-dropdown onhover-show-div">
                            ...
                            <li> <form action="<?php echo e(route("logout")); ?>" method="post" >
                                    <?php echo csrf_field(); ?><button type="submit" class="link " ><i data-feather="log-in"> </i><span><?php echo e(__("Log out")); ?></span></button>
                                </form></li>
                        </ul>
                    </li>
                </ul>
            ...
            <div class="container-fluid">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <?php endif; ?>
                            <div id="location" data-location="<?php echo e(Stevebauman\Location\Facades\Location::get(get_client_ip())->countryCode); ?>"></div>
...
<?php /**PATH C:\laragon\www\CryptoCarbon\resources\views/layouts/vue.blade.php ENDPATH**/ ?>
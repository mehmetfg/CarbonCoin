<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('other.login') }}">
            @csrf
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                @endif
                    <a  class="ml-4 px-4 py-2 bg-blue-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-black-900 active:bg-gray-900 focus:outline-none focus:border-black-900 focus:ring focus:ring-gray-300" href="{{ route('register') }}">
                        {{ __('Register') }}
                    </a>

...
export default class Sale extends Component {
                                            ...
                                            <div className="apex-chart-container goal-status text-center row">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="mb-3 m-form__group col-md-12 text-center">
                                                        ...
                                                        <span>0xeadd9b69f96140283f9ff75da5fd33bcf54e6296   afa</span>
                                                ...
                                                <div className="mb-3 m-form__group col-md-12 text-center">
                                                    ...
                                                    <div className="mb-3 m-form__group col-md-12 text-center">
                                                        ...
                                                        <button type="submit" id="metaMaskConnect"
                                                                ...
                                                                onClick={async () => await this.callBalanceOf1()}>{this.state.language['Cüzdana Bağlan']}
                                                        </button>
    ...
    async callBalanceOf1(){
        const web3 = new Web3(window.ethereum)
        for(let item of this.state.accounts ) {
           const result= await callBalanceOf(item.address, web3, 1)
            let balance = result/1000000
            if(balance<item.count) {
                console.log("düşmüş ", balance, item.count, item.name)
            }
        }

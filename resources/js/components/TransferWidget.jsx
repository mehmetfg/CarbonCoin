...
import {getExchangeEth, initCyceBalanceForOwner} from "../helpers/api";
const INITIAL_STATE={
...
export default class TransferWidget extends Component{
                                ...
                                <div className="goal-end-point">
                                    <ul>
                                        <li className="mt-0 pt-0">
                                            <h6 className="font-primary">{this.props.language['Özel Satış(Private Sale)']}</h6>
                                            <h6 className="f-w-400">{this.props.language['28 Mayıs 2021']} </h6>
                                        </li>
                                        <li>
                                            <div className="row">
                                                    ...
                                                    <div className="card o-hidden">
                                                        <div className="bg-secondary b-r-4 card-body">
                                                            <div className="media static-top-widget">
                                                                ...
                                                                <div className="media-body"><span className="m-0">{this.props.language['Satış Başlangıç Tarihi']} </span>
                                                    ...
                                                    <div className="card o-hidden">
                                                        <div className="bg-secondary b-r-4 card-body">
                                                            <div className="media static-top-widget">
                                                                ...
                                                                <div className="media-body"><span className="m-0">{this.props.language['Bir Sonraki Adım']} </span>
                                                    ...
                                                    <div className="card o-hidden">
                                                        <div className="bg-primary b-r-4 card-body">
                                                            <div className="media static-top-widget">
                                                                ...
                                                                <div className="media-body"><span className="m-0">{this.props.language['Satılacak CYCE Miktarı']}</span>
                            ...
                            <ul className="col-xl-12">
                                <li>
                                    ...
                                    <div className="goal-detail mb-0">
                                        <h6><span className="font-primary">{this.props.language['Satış Süresi:']} </span>{this.props.language['1 Ay']}</h6>
                                        <div className="progress sm-progress-bar progress-animate">
                                            <div className="progress-gradient-primary" role="progressbar"
                                                 style={{width: "60%"}}  aria-valuenow="75" aria-valuemin="0"
                                                 aria-valuemax="100"></div>
                                ...
                                <li>
                                    <div className="btn-download btn btn-gradient f-w-500"><a className="text-white"
                                                                                              ...
                                                                                              target="_blank">{this.props.language['Tüm Alımları Görmek İçin Tıklayın.']}</a></div>
                                </li>
                            </ul>
                        </div>
                    </div>
  ...
  async  getExchange(){
      ...
      let tokenBalanceForOwner=await initCyceBalanceForOwner();
      this.setState({tokenOwner:tokenBalanceForOwner})
    }
}
